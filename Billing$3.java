...
final class Billing$3 implements SkuDetailsResponseListener {
   // $FF: synthetic field
   private Billing hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

   Billing$3(Billing var1) {
   ...
   public final void onSkuDetailsResponse(BillingResult var1, List var2) {
      if(var2 != null && var2.size() > 0) {
         ...
         this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.GotProductDetails(true, var3.getSku(), var3.getTitle(), var3.getDescription(), var3.getPriceCurrencyCode(), var3.getPrice());
      } else {
